...
const HeroSection = () => {
  return (
    <section className="bg-[#F2F4F7] h-screen w-full relative px-4 text-[#101828] ">
      <div className="md:max-w-[76.375rem] w-full mx-auto">
        <header className="sticky top-6">
          <Navbar />
        </header>
        <div className="max-w-[37.5rem] mt-16 space-y-5">
      ...
      <div className="h-full md:block hidden absolute right-0 top-0 w-1/2">
        <Image
          src={bgMobile}
          alt="Bg Image"
          fill
